...
//                OtherRequestFragment fragment=new OtherRequestFragment();
//                    getFragmentManager()
//                            .beginTransaction()
//                            .addToBackStack(TAG)
...
//        });
    ...
    public void post_data(String dealer_id) {
        ...
        Call<AdminMsgListPojo> call = a_otherListInterface.postDataAdmin(dealer_id);
    ...
    class OtherReqListAadpter extends RecyclerView.Adapter<OtherReqListAadpter.ViewHolder> {
        ...
        public OtherReqListAadpter.ViewHolder onCreateViewHolder(ViewGroup parent,
            ...
            itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.a_otherreq_item, parent, false);
            OtherReqListAadpter.ViewHolder vh = new OtherReqListAadpter.ViewHolder(itemView);
            return vh;
        }
        ...
        @Override
        public void onBindViewHolder(final OtherReqListAadpter.ViewHolder holder, final int position) {
            ...
            holder.btn_send.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    OtherRequestFragment fragment = new OtherRequestFragment();
                    Bundle b = new Bundle();
                    b.putString("admin_id", dealer_id);
                    b.putString("receiver_role", list.get(position).getRole());
                    b.putString("receiver_id", list.get(position).getDId());
