...
import com.sarps.azhar_sarps.servicereportapp.Dealer_fragments.EscalateComplaintFragment;
import com.sarps.azhar_sarps.servicereportapp.Dealer_fragments.OtherRequestListFragment;
...
public class MainActivity_Dealer extends AppCompatActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
    ...
    private List<MenuObject> getMenuObjects() {
        ...
        MenuObject send = new MenuObject("Escalate List");
        send.setResource(R.drawable.icon_escalation_complaint);

        MenuObject like = new MenuObject("Other Requests");
        Bitmap b = BitmapFactory.decodeResource(getResources(), R.drawable.icon_other_request);
        like.setBitmap(b);
...
//        menuObjects.add(addFav);
    ...
    public void onBackPressed() {
        if (fragmentManager.getBackStackEntryCount() == 1) {
            AlertDialog.Builder alertbox = new AlertDialog.Builder(MainActivity_Dealer.this);
...
//    }
    ...
    public void dialog(String name, String location, String email, String phone) {
        Dialog dialog = new Dialog(MainActivity_Dealer.this);
