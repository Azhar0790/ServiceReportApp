...
public class OtherRequestListFragment extends Fragment {
    ...
    public void post_data(String dealer_id) {
        ...
        Call<AdminMsgListPojo> call = a_otherListInterface.postDataDel(dealer_id);
    ...
    class OtherReqListAadpter extends RecyclerView.Adapter<OtherReqListAadpter.ViewHolder> {
        ...
        @Override
        public OtherReqListAadpter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
